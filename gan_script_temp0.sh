###
 ...
 # @LastEditTime: 2021-08-03 23:29:09
 # @LastEditors: Kitiro
 # @Description: 
 # @FilePath: /liujinlu_code/gan_script_temp0.sh
### 
att='100'
x_w='10 100 500'
cent='1 10 50'
...
do
    ...
    do
        ...
        do
            for i in $inst
            do  
                python train_gan_attention_for_class_with_noise.py --gpu 0 --scale 0.001 --k_cla 1 --k_inst $i --selected_ratio 0.8 --endEpoch 3000 --att_w 10 --x_w $x --cent_w $c --batchsize 1024 --dataset $d --gzsl --split_num 8 &
            done
            wait
        done
    done
